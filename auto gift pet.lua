...
getgenv().DataGetTool = {
    {
        name_pet    = "Dog",  -- nil = gift toàn bộ pet đủ điều kiện trừ pet trong blacklist (unvalidToolNames), chủ yếu gom pet age
        min_age     = 75,
        max_age     = 101,
        min_weight  = 0.5,           
    ...
    {
        name_pet    = "Bunny",  -- nil = gift toàn bộ pet đủ điều kiện trừ pet trong blacklist (unvalidToolNames), chủ yếu gom pet age
        min_age     = 75,
        max_age     = 101,
        min_weight  = 0.5,           
        unequip_Pet = true, -- auto pickup pet đủ điều kiện để gift
    ...
    {
        name_pet    = "Golden Lab",  -- nil = gift toàn bộ pet đủ điều kiện trừ pet trong blacklist (unvalidToolNames), chủ yếu gom pet age
        min_age     = 75,
        max_age     = 101,
        min_weight  = 0.5,           
        unequip_Pet = true, -- auto pickup pet đủ điều kiện để gift
    ...
    {
        name_pet    = "Starfish",  -- nil = gift toàn bộ pet đủ điều kiện trừ pet trong blacklist (unvalidToolNames), chủ yếu gom pet age
        min_age     = 75,
        max_age     = 101,
        min_weight  = 0.5,           
        unequip_Pet = true, -- auto pickup pet đủ điều kiện để gift
